...
First off, thank you for considering contributing to faucet.

faucet is an open source project and we love to receive contributions from
...
writing code which can be incorporated into faucet itself.
...
If you think you have found a bug in faucet, first make sure that you
are testing against the latest version of faucet - your issue may already
...
If you have a bugfix or new feature that you would like to contribute to faucet, please find or open an issue
...
You will need to fork the main faucet code or documentation repository and clone
...
Then sit back and wait. There will probably be discussion about the changes and, if any are needed, we would love to work with you to get them merged into faucet.

*CONTRIBUTING.md is based on [CONTRIBUTING-template.md](https://github.com/nayafia/contributing-template/blob/master/CONTRIBUTING-template.md)* , [elasticsearch/CONTRIBUTING](https://github.com/elastic/elasticsearch/blob/master/CONTRIBUTING.md) and [spark/CONTRIBUTING](https://github.com/apache/spark/blob/master/CONTRIBUTING.md)

[github-issues]: https://github.com/symbol/faucet/issues
