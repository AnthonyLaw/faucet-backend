    ...
    it('can validate input.', () => {
        ...
        const mockValidationInputs = [
            ...
            },
            {
                ...
                faucetBalance: 1000000000,
                unconfirmedTransactions: [],
                expectedError: 'Transfer amount can not more than 500',
            },
            {
                receiptAddress: 'TCKH5L543TQKUPHIUAWMNYL7GNQYEY2UGMECB4D3',
                transferAmount: 100000000,
            ...
            },
            {
                ...
                faucetBalance: 1000000000,
                unconfirmedTransactions: [],
                expectedError: 'Your account already has enough balance.',
            },
            {
                receiptAddress: 'TCKH5L543TQKUPHIUAWMNYL7GNQYEY2UGMECB4D3',
                transferAmount: 100000000,
                ...
                expectedError: 'You have pending transaction, please wait for it to be confirmed.',
            }
        ]
